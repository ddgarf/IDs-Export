...
api_id = 19164687
api_hash = 'd67e878eab2665ededc4c786293c051a'

peer_channel_id = -1517138975 # replace with channel peer 

async def export_messages(export_file="C:\\Users\\ddgar\\Desktop\\autoPaste\\github\\channels.txt"):

    async with TelegramClient('ddgarciaf', api_id, api_hash) as client:
...
def gitUpdate():
    gitRepo = r'C:\\Users\\ddgar\\Desktop\\autoPaste'
